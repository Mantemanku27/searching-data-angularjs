...
function ($stateProvider, $urlRouterProvider, $controllerProvider, $compileProvider, $filterProvider, $provide, $ocLazyLoadProvider, jsRequires) {
    ...
    $stateProvider.state('app', {
        ...
        // URL CRUD Siswa
            .state('app.siswas', {
                url: '/siswas/:id',
                templateUrl: 'assets/src/siswas/siswas-list.html',
                title: 'Data Siswa',
                resolve: loadSequence('SiswaCtrl', 'siswa_service'),
            })

            .state('app.siswas-create', {
                url: '/siswas-create/:id',
                templateUrl: 'assets/src/siswas/siswas-create.html',
                title: 'Create Data Siswa',
                resolve: loadSequence('SiswaCreateCtrl', 'siswa_service','ngImgCrop'),
            })

            .state('app.siswas-edit', {
                url: '/siswas-edit/:id',
                templateUrl: 'assets//src/siswas/siswas-edit.html',
                title: 'Edit Data Siswa',
                resolve: loadSequence('SiswaEditCtrl', 'siswa_service','ngImgCrop'),
            })
    //urusan
        .state('app.members', {
            url: '/members',
