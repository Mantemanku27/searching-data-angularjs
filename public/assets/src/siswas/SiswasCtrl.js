...
app.controller('SiswaCtrl', ['$state','$scope', 'siswas', 'SweetAlert', '$uibModal', '$log', '$http','$timeout', function ($state,$scope, siswas, SweetAlert,$uibModal,$log) {
    ...
    $scope.print = function () {
        window.open ('../api/v1/cetak-siswa','_blank');
    };
    ...
    // Init Get Data
    siswas.get($scope.main.page, $scope.main.term)
        .success(function (data) {
            // Change Loading Status
            $scope.setLoader(false);

            // Result Data
            $scope.dataSiswas = data.data;
